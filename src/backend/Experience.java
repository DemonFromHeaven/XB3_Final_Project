...
@Deprecated
/**
 * A library of functions for reading and writing experience to storage, and
 * storing it as an ADT. This is so that the application can keep track of this
 * list between use sessions.
 * 
...
public class Experience {
	 ...
	 * 
	 * @return An array list of the restaurant IDs of the restaurants this person
	 *         has been to.
	 */
	...
	/**
	 * Read the restaurants that the user has been to from storage. Returns an empty
