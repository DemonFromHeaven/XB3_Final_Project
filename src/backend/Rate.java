...
public class Rate {
	...
	public static void main(String[] args) throws Exception {
		...
		// mlHC2XcU9Bows6cnYEmRgg is in Toronto --> should yield results; Toronto is: 43.657716 -79.383931
		...
		for (;;) {
			...
			while(selection < 0 || selection > results.size()) {
				System.out.println("Please enter a number between 1 and" + results.size() + " to indicate which restaurant you visited");
