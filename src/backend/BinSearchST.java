...
//TODO: Completely Javadoc file. I'm sleepy. -Rohan

@SuppressWarnings("unchecked")
public class BinSearchST<Key extends Comparable<Key>, Value> implements ST<Key, Value>{
    ...
    /**
     * Default constructor for BinSearchST
     */
    public BinSearchST() {
     ...
     * @param capacity		new capacity of symbol table
     */
    ...
    /**
     * Function to determine the size of the current symbol table
     * @return		returns the size of the current symbol table
     */
    public int size() {
        return size;
    }
    ...
    /**
     * Gets the value of the desired key
     * @param key
     * @return
     */
